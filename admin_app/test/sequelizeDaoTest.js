...
var log = conf.logger;
var dao = require('../dao/sequelizeDao.js');
    ...
    it('should get countries ok', function(done){
        dao.getCountries(function(err, countries) {
            ...
            for (var ci in countries) {
                ...
                // output the JSON representation of the country.
                log.debug('Country JSON: ' + JSON.stringify(country));
                // this show's a lot more detail about the country object than the above line
                util.log(util.inspect(country, true));
